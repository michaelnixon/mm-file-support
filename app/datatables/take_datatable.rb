  ...
  def data
    records.map do |record|
      [
        ...
        link_to(record.name, take_path(record),class:"underlined"), record.movement_group.try(:name), record.movers.map{|mover| link_to(mover.name, mover_path(mover),class:"underlined") }.join(", ")
